...
import com.moveit.client.facebook.xfbml.FbPromptPermission;
...
public class FacebookConnect {
            ...
            $wnd.FB.Connect.get_status().waitUntilReady( function( status ) { 
                switch ( status ) {
                    case $wnd.FB.ConnectState.appNotAuthorized: 
                        cs=@com.moveit.client.facebook.ConnectState::appNotAuthorized;
                    break;
                    case $wnd.FB.ConnectState.connected : 
                        cs=@com.moveit.client.facebook.ConnectState::connected;
                    break;
                    case $wnd.FB.ConnectState.userNotLoggedIn: 
                        cs=@com.moveit.client.facebook.ConnectState::userNotLoggedIn;
                    break;
                }
                @com.moveit.client.facebook.FacebookConnect::waitUntilReadySuccess(Lcom/google/gwt/user/client/rpc/AsyncCallback;Lcom/moveit/client/facebook/ConnectState;)(callback,cs);
            })
        });
    }-*/;
    ...
    private static native void streamPublishNative(JavaScriptObject params, AsyncCallback<JavaScriptObject> callback) /*-{
        ...
        function (postId, exception){
            if ( typeof ( postId ) == 'string' && postId != "null" ) {
                ...
                @com.moveit.client.facebook.FacebookConnect::callbackSuccess(Lcom/google/gwt/user/client/rpc/AsyncCallback;Lcom/google/gwt/core/client/JavaScriptObject;)(callback,result);
            } else {
                var ex = new Object();
                ex.message = " Could not publish stream";
                @com.moveit.client.facebook.FacebookConnect::callbackError(Lcom/google/gwt/user/client/rpc/AsyncCallback;Lcom/google/gwt/core/client/JavaScriptObject;)(callback,ex);
            }
        }, 
        autoPublish, actorId );
    }-*/;
    ...
    private static native void defineLoginCallbackFunction(LoginCallback callback) /*-{
        $wnd.facebookConnectLogin = function() {
            @com.moveit.client.facebook.FacebookConnect::onLoginProxy(Lcom/moveit/client/facebook/LoginCallback;)(callback);
        };
    }-*/;
